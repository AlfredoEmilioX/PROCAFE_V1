...
<?php $__env->startSection('title','Nosotros | PROCAFES'); ?>
  ...
  <div class="container">
    <div class="row justify-content-center g-4">
      <div class="col-lg-5 d-flex justify-content-center">
        <img
          src="<?php echo e(asset('images/nosotros.jpg')); ?>"
...
<section class="py-5 bg-white">
  <div class="container text-center">
    ...
    <div class="d-flex justify-content-center">
      <img
        src="<?php echo e(asset('images/equipo.jpg')); ?>"
        alt="Equipo PROCAFES"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\021025\PROCAFE_V1\resources\views/nosotros.blade.php ENDPATH**/ ?>